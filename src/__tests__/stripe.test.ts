...
describe('stripe actions', () => {
    ...
    describe('createStripeCheckoutSession', () => {
        ...
        it('should include correct success and cancel URLs', async () => {
            ...
            (stripe.checkout.sessions.create as jest.Mock).mockResolvedValue({ url: 'https://checkout.stripe.com/test' })
        ...
        it('should handle Stripe API errors gracefully', async () => {
            ...
            (stripe.checkout.sessions.create as jest.Mock).mockRejectedValue(new Error('Stripe API down'))
