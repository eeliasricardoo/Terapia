    ...
    if (!session) {
        return (
            <Card className="col-span-1 md:col-span-2 lg:col-span-2 border-none shadow-md overflow-hidden relative p-8 flex flex-col items-center justify-center text-center bg-white min-h-[300px]">
                ...
                <p className="text-slate-500 mb-6">Você não possui atendimentos marcados para os próximos dias.</p>
                <Link href="/busca">
                    <Button className="bg-blue-600 text-white hover:bg-blue-700">Encontrar um Psicólogo</Button>
                </Link>
            </Card>
        )
    }
