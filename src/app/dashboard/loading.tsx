          ...
          <CardContent>
            <div className="grid grid-cols-5 gap-2 h-32 mt-4">
              <div className="flex flex-col justify-end items-center gap-2 h-full">
                <Skeleton className="h-[20%] w-[32px] rounded-t-md bg-amber-100" />
                <Skeleton className="h-[16px] w-[24px] bg-slate-100" />
              </div>
              <div className="flex flex-col justify-end items-center gap-2 h-full">
                <Skeleton className="h-[40%] w-[32px] rounded-t-md bg-amber-200" />
                <Skeleton className="h-[16px] w-[24px] bg-slate-100" />
              </div>
              <div className="flex flex-col justify-end items-center gap-2 h-full">
                <Skeleton className="h-[30%] w-[32px] rounded-t-md bg-emerald-100" />
                <Skeleton className="h-[16px] w-[24px] bg-slate-100" />
              </div>
              <div className="flex flex-col justify-end items-center gap-2 h-full">
                <Skeleton className="h-[80%] w-[32px] rounded-t-md bg-emerald-300" />
                <Skeleton className="h-[16px] w-[24px] bg-slate-100" />
              </div>
              <div className="flex flex-col justify-end items-center gap-2 h-full">
                <Skeleton className="h-[60%] w-[32px] rounded-t-md bg-amber-400" />
                <Skeleton className="h-[16px] w-[24px] bg-slate-100" />
              </div>
            </div>
          </CardContent>
