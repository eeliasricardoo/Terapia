...
export function AddressInfoCard({ user, setUser, isLoading, setIsLoading }: AddressInfoCardProps) {
    const handleSaveAddress = async () => {
        ...
        try {
            ...
            toast.success('Endereço atualizado!', { description: 'Seus dados de endereço foram salvos com sucesso.' })
        } catch (error) {
    ...
    return (
        <Card>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            onChange={(e) => setUser(prev => prev ? { ...prev, address_line: e.target.value } : null)}
                            className="pl-9"
                            disabled={isLoading}
                    ...
                    <div className="space-y-2 md:col-span-1">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                id="zip_code"
                                value={user?.zip_code || ''}
                                onChange={(e) => setUser(prev => prev ? { ...prev, zip_code: e.target.value } : null)}
                                className="pl-9"
                                disabled={isLoading}
            ...
            <CardFooter className="flex justify-end border-t p-6">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white" onClick={handleSaveAddress} disabled={isLoading}>
                    {isLoading ? (
                        <>Salvando...</>
                    ) : (
                        <>
