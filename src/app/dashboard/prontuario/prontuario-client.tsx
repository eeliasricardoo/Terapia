...
export function ProntuarioClient({ evolutions }: ProntuarioClientProps) {
  return (
    <div className="space-y-6 pb-20">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Meu Prontuário</h1>
        <p className="text-muted-foreground">
          Aqui você encontra os resumos e orientações que seu psicólogo compartilhou com você.
        </p>
      </div>
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-amber-800 leading-relaxed mt-1">
              Estes resumos são destinados apenas a você e ao seu psicólogo. De acordo com o Código
              de Ética Profissional do Psicólogo, as informações técnicas detalhadas (notas
              privadas) são mantidas em sigilo e não são exibidas aqui para sua segurança e
              conforto.
            </p>
          </div>
        </div>
