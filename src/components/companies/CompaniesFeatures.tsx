...
export function CompaniesFeatures() {
  ...
  return (
    <section className="w-full py-20 md:py-40 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-blue-50/30 rounded-full blur-[120px] mix-blend-multiply pointer-events-none" />
