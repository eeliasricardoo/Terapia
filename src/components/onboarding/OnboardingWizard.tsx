...
export function OnboardingWizard() {
  ...
  const getStepTitle = () => {
    switch (step) {
      case 1:
        return 'Em quais áreas você gostaria de focar?'
      case 2:
        return 'Tem alguma preferência para o seu especialista?'
      case 3:
        return 'Qual sua disponibilidade?'
      case 4:
        return 'Conte-nos um pouco sobre seu histórico'
      default:
        return 'Passo ' + step
    }
  }
  ...
  const getStepDescription = () => {
    switch (step) {
      case 1:
        return 'Selecione todas que se aplicam. Isso nos ajudará a encontrar o especialista adequado para ti.'
      case 2:
        return 'Essas preferências são opcionais, mas ajudam a refinar o match.'
      case 3:
        return 'Selecione os dias e períodos que funcionam melhor para você.'
      case 4:
        return 'Essas informações ajudarão o especialista a se preparar para a primeira sessão.'
      default:
        return ''
    }
  }
  ...
  return (
    <Card className="mx-auto max-w-2xl w-full">
      <CardHeader>
        ...
        <CardTitle className="text-3xl text-center font-bold">{getStepTitle()}</CardTitle>
