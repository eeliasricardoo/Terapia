...
import { CloudRain, ShieldCheck, Feather, Utensils, CigaretteOff, Flame } from 'lucide-react'

export const APPROACHES = [
  {
    id: 'tcc',
    label: 'Terapia Cognitivo-Comportamental (TCC)',
    description: 'Foco em mudar padrões de pensamento e comportamento.',
  },
  {
    id: 'psychoanalysis',
    label: 'Psicanálise',
    description: 'Exploração do inconsciente e experiências passadas.',
  },
  { id: 'humanist', label: 'Humanista', description: 'Foco no potencial humano e autodescoberta.' },
  {
    id: 'gestalt',
    label: 'Gestalt-terapia',
    description: 'Ênfase na responsabilidade pessoal e foco no presente.',
  },
  {
    id: 'systemic',
    label: 'Sistêmica',
    description: 'Entende o indivíduo como parte de sistemas (família, trabalho).',
  },
  {
    id: 'jungian',
    label: 'Analítica (Junguiama)',
    description: 'Integração dos aspectos conscientes e inconscientes.',
  },
  {
    id: 'acp',
    label: 'Abordagem Centrada na Pessoa',
    description: 'Ambiente de apoio para o crescimento pessoal.',
  },
]
