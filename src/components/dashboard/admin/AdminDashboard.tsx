                ...
                <div className="space-y-8">
                    <Card className="border-none shadow-sm">
                        ...
                        <CardContent className="space-y-3">
                            <Button variant="outline" className="w-full justify-start text-slate-600 gap-3 border-slate-200" disabled>
                    ...
                    <Card className="border-none shadow-sm bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
                        <CardContent className="p-6">
                            ...
                            <p className="text-blue-100 text-sm leading-relaxed">
                                Psicólogos verificados aparecem instantaneamente na página de busca pública para todos os pacientes.
                            </p>
                        </CardContent>
                    </Card>
                </div>
        ...
        <Card className="border-none shadow-sm bg-white hover:shadow-md transition-shadow">
            <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className={`h-8 w-8 rounded-full flex items-center justify-center ${colors[color as keyof typeof colors]}`}>
