                ...
                <TableCell className="text-right">
                  <div className="flex justify-end">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-8 w-8 text-slate-400 group-hover:text-slate-900"
                    >
            ...
            <div className="flex flex-col h-full bg-white">
              <Tabs defaultValue="records" className="flex flex-col h-full">
                ...
                <div className="flex-1 p-6 overflow-y-auto bg-white">
                  <TabsContent
                    value="records"
                    className="space-y-6 mt-0 animate-in fade-in slide-in-from-bottom-2 duration-300 h-full flex flex-col"
                  >
                  ...
                  <TabsContent
                    value="history"
                    className="space-y-8 mt-0 animate-in fade-in slide-in-from-bottom-2 duration-300"
                  >
