...
const MOODS = [
  {
    ...
    activeBg: 'bg-emerald-50 border-emerald-400 shadow-emerald-100',
  },
  {
    icon: Meh,
    label: 'Neutro',
    color: 'text-amber-500',
    activeBg: 'bg-amber-50 border-amber-400 shadow-amber-100',
  },
  {
    icon: Frown,
    label: 'Mal',
    color: 'text-red-500',
    activeBg: 'bg-red-50 border-red-400 shadow-red-100',
  },
  {
    icon: AlertCircle,
    label: 'Crise',
    color: 'text-purple-500',
    activeBg: 'bg-purple-50 border-purple-400 shadow-purple-100',
  },
]
