                ...
                <Card className="border-none shadow-sm bg-slate-900 text-white overflow-hidden relative group">
                    ...
                    <CardContent className="p-6 relative z-10">
                        ...
                        <div className="flex items-center gap-2 mt-4">
                            <Badge className={`${stats.revenueChange >= 0 ? 'bg-emerald-500/20 text-emerald-300' : 'bg-red-500/20 text-red-300'} hover:bg-opacity-30 border-none`}>
                                ...
                                <TableRow key={transaction.id} className="hover:bg-slate-50/50">
                                    ...
                                    <TableCell>
                                        <Badge
                                            ...
                                            `}
                                        >
                                            {transaction.status === 'completed' || transaction.status === 'paid' ? 'Recebido' :
                                                transaction.status === 'scheduled' || transaction.status === 'pending' ? 'Previsto' : 'Cancelado'}
                                        </Badge>
                                    </TableCell>
