  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      {!dashboardData.isVerified && (
        <Alert
          variant="destructive"
          className="bg-amber-50 border-amber-200 text-amber-900 shadow-sm animate-in slide-in-from-top-4 duration-500"
        >
          <AlertCircle className="h-4 w-4 text-amber-600" />
          <AlertTitle className="font-bold text-amber-800">Perfil em análise</AlertTitle>
          <AlertDescription className="text-amber-700">
            Seu perfil profissional ainda não foi verificado. Você conseguirá utilizar a plataforma
            normalmente, mas não aparecerá nos resultados de busca pública até que sua conta seja
            validada por nossa equipe.
          </AlertDescription>
        </Alert>
      )}
      {/* Header */}
