        ...
        >
          ...
          <div className="space-y-4">
            ...
            <p className="mx-auto max-w-[600px] text-slate-300 text-lg md:text-xl leading-relaxed">
              Cuidar da mente não precisa ser um luxo inatingível. Descubra uma terapia profunda,
              acessível e construída através da verdadeira empatia social.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
            <Button
              asChild
              size="lg"
              className="h-14 px-8 text-lg bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white shadow-[0_0_40px_-10px_rgba(249,115,22,0.5)] transition-all group border-0"
            >
          ...
          <p className="text-slate-400 text-sm mt-6 font-medium">
            ...
            <Link
              ...
              className="text-orange-400 hover:text-orange-300 underline underline-offset-4 decoration-orange-400/30 transition-colors"
            >
              Junte-se ao nosso movimento solidário
            </Link>
            .
          </p>
        </motion.div>
