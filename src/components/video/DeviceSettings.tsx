  ...
  return (
    <div className="space-y-4 w-full">
      <div className="space-y-2">
        ...
        <Select value={currentCam?.device.deviceId} onValueChange={(val) => setCamera(val)}>
      ...
      <div className="space-y-2">
        ...
        <Select value={currentMic?.device.deviceId} onValueChange={(val) => setMicrophone(val)}>
          <SelectTrigger className="bg-white border-slate-200">
      ...
      {speakers.length > 0 && (
        <div className="space-y-2">
          ...
          <Select value={currentSpeaker?.device.deviceId} onValueChange={(val) => setSpeaker(val)}>
            <SelectTrigger className="bg-white border-slate-200">
