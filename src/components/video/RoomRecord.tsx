...
export function RoomRecord() {
  return (
    <>
      <TabsContent
        value="record"
        className="p-4 m-0 flex-1 overflow-y-auto space-y-4 data-[state=active]:flex data-[state=active]:flex-col"
      >
        <Card>
      ...
      <TabsContent
        value="notes"
        className="p-4 m-0 flex-1 data-[state=active]:flex data-[state=active]:flex-col"
      >
        <textarea
