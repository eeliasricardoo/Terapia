  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shadow-sm z-10 shrink-0">
      <div className="flex items-center gap-3">
        <Badge
          variant="outline"
          className="bg-green-50 text-green-700 border-green-200 gap-1.5 px-2 py-1"
        >
        ...
        <div
          className={cn(
            'flex items-center gap-2 font-mono text-sm px-2 py-1 rounded-md border',
      ...
      <div className="flex items-center gap-2">
        <Button variant="ghost" size="sm" className="text-slate-500">
          ...
          {remoteParticipantCount > 0
            ? `${remoteParticipantCount + 1} Participantes`
            : 'Aguardando...'}
        </Button>
